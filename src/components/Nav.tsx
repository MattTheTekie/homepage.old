    ...
    <nav class="z-20 fixed top-0 w-screen my-3 pointer-events-none drop-shadow-lg">
      <div class="mx-auto max-w-7xl px-4 lg:px-6">
        <div class="relative flex h-16 items-center justify-between">
          ...
          <div class="flex flex-1 items-center justify-end">
            <div class="pointer-events-auto flex gap-2 text-gray-300 whitespace-nowrap">
              ...
              <a href="/filehost" class="transition duration-200 hidden bg-gray-900 hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-900 hover:border-gray-700 px-4 py-2 rounded-lg text-md font-bold lg:flex items-center gap-4">
                <FolderIcon/>Files
              </a>
        ...
        <div id="mobile-menu" class="pointer-events-auto space-y-1 py-4 px-3 justify-center items-center bg-gray-800 rounded-lg border-2 border-gray-700 mt-2 hidden">
          ...
          <a href="/filehost" class="transition duration-200 flex lg:hidden hover:bg-gray-800 hover:text-white hover:drop-shadow-2xl border-2 border-gray-800 hover:border-gray-700 px-4 py-2 rounded-lg text-md font-bold items-center gap-4">
            <FolderIcon/>Files
          </a>
