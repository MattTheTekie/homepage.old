  ...
  return (
    <section class="flex flex-col gap-5 mx-auto max-w-6xl px-6 items-center justify-center py-16" style={{ minHeight: 'calc(100dvh - 64px)' }}>
      ...
      <div class="grid sm:grid-cols-3 gap-5">
        ...
        <Card name="Dragon Linux" icon="https://raw.githubusercontent.com/MattTheTekie/MattTheTekie/main/Personal-Scripts/Images/Resized/static.displate.com_800be04aa6f899076275e4dd96dbf9f4_46e904de13eaa602b904b8a5fa5e3e23_460x460.jpg" github="https://github.com/MattTheTekie/MattTheTekie/tree/main/Personal-Scripts/Distromaking" link="https://freedom-hq.github.io/Dragon-Linux/">
